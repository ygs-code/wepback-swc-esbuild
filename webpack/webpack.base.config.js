...
const { entry, plugins } = getEntryPlugins('pages', 'index.html', 'index.js');
        ...
        rules: [
...

            {
                ...
                use: [
                    {
                        loader: swcLoader,
                        options: getTsSwcOptions(isEnvDevelopment, isClient),
                    },
                ],
            },
            {
                ...
                use: [
                    {
                        loader: swcLoader,
                        options: getJSSwcOptions(isEnvDevelopment, isClient),
                    },
                ],
            },
